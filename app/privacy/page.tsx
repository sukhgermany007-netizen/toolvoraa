    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <header className="border-b border-purple-500/10 bg-slate-950/95">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          <a
            href="/"
            className="rounded-lg bg-purple-600 px-5 py-2.5 text-sm font-semibold hover:bg-purple-500"
          >
            Home
          </a>
        </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="space-y-8 text-slate-300 leading-7">
          ...
          <section>
            ...
            <p>
              Some PDF and image tools may allow users to upload files.
              Users should avoid uploading confidential, sensitive or
              personally identifiable information unless it is necessary for
          ...
          <section>
            ...
            <p>
              ...
              the website. However, no internet service can guarantee
              absolute security.
            </p>
          </section>
